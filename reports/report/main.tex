...
\begin{figure*}[ht]
	...
	\caption{Overview of each of the models evaluated in one of the two target (TGT) languages (French
		or German). The baseline \textcolor[HTML]{79d6ae}{Sandwich} model (\subref{fig:sandwich})
		...
		\textcolor[HTML]{38AAAC}{MetaICL-geWECHSELt} (\subref{fig:metaicl-gewechselt}) is the result of
